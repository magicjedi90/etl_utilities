...
def build_column_fragments(
    ...
    """
    Returns a list of strings, each one a column or constraint fragment,
    already quoted for the supplied dialect.
    """
    ...
    if generate_identity_column:
        fragments.append(dialect.identity_fragment_function(table_name))
    ...
    for column_info in column_metadata:
        ...
        fragments.append(data_definition_clause)
...
class Creator:
    ...
    def create_table(
        ...
        # -------------------- build column / constraint list ---------------
        column_fragments = build_column_fragments(
            data_frame,
            dialect,
            table_name=table_name,
            primary_key_column=primary_key_column,
            unique_columns=unique_columns or [],
            varchar_padding=varchar_padding,
            float_precision=float_precision,
            decimal_places=decimal_places,
            generate_identity_column=generate_identity_column,
        )
